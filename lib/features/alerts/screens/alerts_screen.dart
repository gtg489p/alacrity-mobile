...
class _AlertsScreenState extends ConsumerState<AlertsScreen> {
            ...
            return Column(
              children: [
                if (result.isStale)
                  OfflineBanner(
                    cacheKey:
                        result.cacheKey ?? CacheKeys.disruptions,
                    onRetry: () =>
                        ref.invalidate(disruptionListProvider),
                  ),
                Expanded(
  ...
  List<Disruption> _applyFilter(List<Disruption> disruptions) {
    return switch (_activeFilter) {
      ...
      'Equipment' =>
        disruptions.where((d) => d.type == 'equipment').toList(),
      'Material' =>
        disruptions.where((d) => d.type == 'material').toList(),
